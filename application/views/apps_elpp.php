...
<!-- Disability   -->
  ...
  <div class="form-group row">
    <label for="jantina" class="col-sm-4 col-form-label">Sector</label>
    <div class="col-sm-8">
      <select name="sector" id="payment" class="form-control">
...
<option value="Private">Private</option>
 ...
 <div class="form-group row">
    <label for="jantina" class="col-sm-4 col-form-label">Job Title</label>
    <div class="col-sm-8">
      <input name="job_title" type="text" class="form-control" id="job_title" value="<?php echo set_value('job_title'); ?>">
  </div>
 </div>

 <div class="form-group row">
    <label for="jantina" class="col-sm-4 col-form-label">Name of Organization</label>
    <div class="col-sm-8">
 ...
 <div class="form-group row">
    <label for="jantina" class="col-sm-4 col-form-label">Organization Phone</label>
    <div class="col-sm-8">
 ...
 <div class="form-group row">
    <label for="jantina" class="col-sm-4 col-form-label">Organization Address</label>
    <div class="col-sm-8">
 ...
 <div class="form-group row">
   ...
   <div class="form-group row">
    <label for="jantina" class="col-sm-4 col-form-label">Officer In Charge</label>
    <div class="col-sm-8">
